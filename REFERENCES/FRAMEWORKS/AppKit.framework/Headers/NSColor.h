...
+ (NSColor *)controlColor;			// Control face and window background color
...
+ (NSColor *)scrollBarColor;			// Scroll bar face
+ (NSColor *)controlBackgroundColor;		// Background of controls (browser, tableview, clipview, ...)
