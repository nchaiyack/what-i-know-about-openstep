/* Copyright (c) 1992 NeXT Computer, Inc.  All rights resereved. */
/*
...
#endif
#if	defined(_POSIX_SOURCE)
#define	SYS_getposix	153
#define	SYS_setposix	154
#else
				/* 153 is unused */
...
#define SYS_getdents	174
				...
				/* 178 is unused */
#if defined(_POSIX_SOURCE)
#define SYS_waitpgrp	179
#define SYS__utime	180
#define SYS__setgid	181
#define SYS_uname	182
#define SYS_setpgid	183
#else
				/* 179 is unused */
				/* 180 is unused */
				/* 181 is unused */
