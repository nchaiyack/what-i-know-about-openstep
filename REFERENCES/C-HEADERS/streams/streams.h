...
NEXTPDO int _NXStreamFillBuffer(NXStream *s);
NEXTPDO int _NXStreamFlushBuffer(NXStream *s, unsigned char c);
NEXTPDO int _NXStreamChangeBuffer(NXStream *s, unsigned char ch);
...
NEXTPDO void NXPrintf(NXStream *s, const char *format, ...);
NEXTPDO void NXVPrintf(NXStream *s, const char *format, va_list argList);
 /*
...
NEXTPDO int NXScanf(NXStream *s, const char *format, ...);
NEXTPDO int NXVScanf(NXStream *s, const char *format, va_list argList);
 /*
...
NEXTPDO void NXUngetc(NXStream *s);		
 /*
    backs up one character previously read by getc.  Only a single character
    can be backed over between reads.
  */
  
NEXTPDO void NXClose(NXStream *s);		
 /*
    closes stream s.
  */
  
NEXTPDO NXStream *NXOpenFile(int fd, int mode);
 /*
...
NEXTPDO NXStream *NXOpenPort(port_t port, int mode);
 /*
...
NEXTPDO NXStream *NXOpenMemory(const char *addr, int size, int mode);
 /*
...
NEXTPDO NXStream *NXMapFile(const char *name, int mode);
 /*
...
NEXTPDO int NXSaveToFile(NXStream *s, const char *name);
 /*
    Write the contents of a memory stream to a file .
  */

NEXTPDO void NXGetMemoryBuffer(NXStream *s, char **addr, int *len, int *maxlen);
 /*
    return the memory buffer, the current length, and the max length
    of the buffer. Use the maxlen value when you vm_deallocate.
  */

NEXTPDO void NXCloseMemory(NXStream *s, int option);
 /*
...
NEXTPDO void NXRegisterPrintfProc(char formatChar, NXPrintfProc *proc,
							void *procData);
 /*
